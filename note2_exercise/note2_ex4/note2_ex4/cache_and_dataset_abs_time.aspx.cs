...
namespace note2_ex4
{
    public partial class cache_and_dataset_at : System.Web.UI.Page
    {
        ...
        public object GetCaeheData()
        {
            if (Cache["Region"] == null)
            {
                ...
                da.Fill(ds);
                Cache.Insert("Region", ds, null, DateTime.Now.AddSeconds(5), System.Web.Caching.Cache.NoSlidingExpiration);
