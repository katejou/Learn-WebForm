...
namespace note2_ex4
{
    public partial class cache_and_dataset_st : System.Web.UI.Page
    {
        ...
        public object GetCaeheData()
        {
            if (Cache["Region"] == null)
            {
                ...
                da.Fill(ds);
                Cache.Insert("Region", ds, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromSeconds(5));
