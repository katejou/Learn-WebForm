<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ISerialization_XML_serial_ex.aspx.cs" Inherits="note3_ex1.Serialize.ISerialization_XML_serial_ex" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <br />
            <h2>自訂序列化(實作 ISerializable 介面)</h2>
            <br />
